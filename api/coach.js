...
const STOP5_PROMPT =
  ...
  "using the STOP5 review model with EXACTLY these four headings, in this order:\n\n" +
  "SITUATION\n" +
  "- Briefly set the scene: what was happening in the game/period based on the commentary.\n\n" +
  ...
  "Be practical, concise and specific to what the verbatims actually say. Do not invent events that are not implied. " +
  "Use plain text headings exactly as written above (no markdown symbols).";
